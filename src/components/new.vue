    ...
    export default {
        methods: {
            handleCurrentChange(val) {
                ...
                axios.get("https://cors-anywhere.herokuapp.com/http://gallery.dev.webant.ru/api/photos?new=true&popular=false&page=" + id_page +"&limit=15","accept: application/json")
